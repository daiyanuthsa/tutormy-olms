...
return new class extends Migration {
    ...
    public function up(): void
    {
        Schema::create('document_versions', function (Blueprint $table) {
            ...
            $table->foreignId('published_by_user_id')->constrained('user')->nullOnDelete(); // User who published the version, nullable if not published
            $table->foreignId('created_by_user_id')->constrained('user')->nullOnDelete(); // User who created the version
            $table->timestamps();
