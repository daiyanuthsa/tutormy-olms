export default function PrimaryButton({
    ...
    const baseStyles = 'inline-flex items-center font-bold rounded-full px-6 lg:px-10 py-2 transition duration-150 ease-in-out focus:outline-none focus:ring-2 focus:ring-primary-3 focus:ring-offset-2';
