        ...
        >
            ...
            <main className='space-y-1'>
                <div className='py-1 px-5 bg-primary-2 rounded-full inline-flex justify-center items-center'>
                    <span className='font-semibold text-sm'>{article.category_name}</span>
                </div>

                <h2 className='text-3xl font-bold'>{article.name}</h2>

                <p className='text-lg font-medium'>{article.short_description}</p>

                <div className='flex gap-4 items-center pt-1'>
                    <div className="flex items-center gap-1">
                        <Icon icon="mdi:eye-outline" className="w-4 h-4" />
                        <span className="text-primary-1 text-sm font-semibold">2.5m</span>
                    </div>
                    <div className="flex items-center gap-1">
                        <Icon icon="mdi:calendar-outline" className="w-4 h-4" />
                        <span className="text-primary-1 text-sm font-semibold">{article.published_at}</span>
                    </div>
                </div>
            </main>
        </Link>
