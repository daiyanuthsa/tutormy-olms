...
const HeroComponents = () => {
    return (
        <section
            className="pt-5 relative lg:pt-20 pb-16 bg-cover lg:bg-contain bg-no-repeat bg-center overflow-hidden"
            style={{ backgroundImage: "url('/assets/stars-component.webp')" }}
        >
            <div className="absolute w-60 h-60 lg:w-80 lg:h-80 bg-purple-700 opacity-30 blur-3xl rounded-full left-[-100px] lg:top-1/3 z-0" />
            <div className='container text-white grid grid-cols-1 md:grid-cols-2 gap-10 items-center relative z-10'>
                ...
                <div className="relative w-full flex items-center justify-center">
                    ...
                    <div className="relative z-10 w-full h-60 lg:h-80 xl:h-96 bg-neutral-800 rounded-3xl overflow-hidden shadow-lg flex items-center justify-center">
                        <img
                            src="/assets/hero.png"
                            alt="Belajar Online"
