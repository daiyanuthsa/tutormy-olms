        ...
        <section id='pricelist'>
            <div className='container mx-auto py-16 lg:py-20 space-y-20 text-white'>
                <div className='space-y-5 flex flex-col items-center'>
                    ...
                    <p className="text-center lg:text-xl max-w-2xl">Lorem ipsum dolor sit amet consectetur. Odio dolor arcu ullamcorper dictum nulla ph</p>
                </div>
                ...
                <div className="flex flex-col lg:flex-row justify-center items-center xl:items-stretch gap-14 lg:gap-10 xl:gap-14 max-w-6xl mx-auto">
                    {plans.map((plan) => (
                        ...
                        >
                            <div
                                className={`rounded-2xl p-4 sm:p-6 xl:p-8 w-64 sm:w-72 xl:w-80 h-auto relative ${selectedPlan === plan.id
                            ...
                            >
                                ...
                                <div className="text-center mb-6">
                                    ...
                                    <div className="mb-4">
                                        <div className="text-2xl md:text-3xl font-bold mb-1">{plan.duration}</div>
                                        <div className="text-3xl md:text-4xl font-bold mb-2">{plan.price}</div>
                                        <div className="text-xs md:text-sm line-through">
                                            {plan.monthlyPrice} <span className="">/bulan</span>
                                        </div>
                                    </div>
                                ...
                                <div className="mb-6">
                                    <button
                                        className={`w-full py-2 md:py-3 px-4 md:px-6 rounded-full font-semibold transition-all duration-200 ${selectedPlan === plan.id
