...
<body>
    <div class="container">
        ...
        <p>Selamat! Anda telah menyelesaikan kelas <strong>{{ $certificate->courseStudent->course->name ?? 'kelas' }}</strong>.</p>

        <p>Kami telah menyiapkan sertifikat digital Anda. Silakan klik tombol di bawah ini untuk melihat atau mengunduh sertifikat Anda:</p>
